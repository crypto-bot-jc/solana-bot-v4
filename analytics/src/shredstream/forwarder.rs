...
use super::analyser::{self, recv_from_channel_and_analyse_shred, ShredEntry}; 
...
use super::main::resolve_hostname_port;
...
mod tests {
    ...
    use crate::shredstream::forwarder::{recv_from_channel_and_send_multiple_dest, ShredMetrics};
    ...
    fn test_2shreds_3destinations() {
        ...
        recv_from_channel_and_send_multiple_dest(
            ...
            &Arc::new(RwLock::new(Deduper::<2, [u8]>::new(
                &mut rand::thread_rng(),
                crate::shredstream::forwarder::DEDUPER_NUM_BITS,
            ))),
            &udp_sender,
